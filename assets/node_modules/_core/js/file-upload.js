  ...
  function file_upload(element, options) {
    ...
    var defaults = {
      ...
      tpl: {
        ...
        message: '<div class="card-text mdb-upload-message"><i class="fa fa-cloud-upload-alt"></i><p>{{ default }}</p></div>',
        ...
        clearButton: '<button type="button" class="btn btn-sm btn-danger">{{ remove }}<i class="fa fa-trash ml-1"></i></button>',
